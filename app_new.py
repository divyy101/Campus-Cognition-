...
from services.gemini_service import analyze_study_materials, analyze_code, is_api_available, get_api_status, fetch_live_scholarships, fetch_live_internships
