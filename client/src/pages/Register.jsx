...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 relative overflow-hidden bg-[#020617]">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-emerald-600/20 blur-[120px] animate-blob" />
        <div className="absolute top-[20%] -left-[10%] w-[40%] h-[60%] rounded-full bg-indigo-600/20 blur-[120px] animate-blob animation-delay-2000" />
        <div className="absolute -bottom-[20%] right-[20%] w-[60%] h-[50%] rounded-full bg-amber-600/20 blur-[120px] animate-blob animation-delay-4000" />
      </div>
