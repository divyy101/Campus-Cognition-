  ...
  return (
    <div className="flex min-h-[100dvh] bg-[var(--bg)]">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-[100dvh] overflow-y-auto overflow-x-hidden custom-scrollbar">
        <Navbar title="Opportunity Agent" />
        ...
        <main className="flex-1 px-4 sm:px-8 py-8 max-w-7xl mx-auto w-full space-y-12 pb-24">
          ...
          <PageHeader
            ...
            description="Discover roles that fit your skill graph."
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="lg:w-[320px] shrink-0 space-y-6">
              <div className="cc-card p-6 sticky top-[100px]">
                <h3 className="text-sm font-bold uppercase tracking-wider text-[var(--text-secondary)] mb-4">Neural Search Parameters</h3>
                      ...
                      >
                        ...
                        <div className="flex justify-between items-start mb-4 mt-2">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-xs font-bold uppercase tracking-wider text-[var(--text-muted)] mb-0.5">{item.company}</div>
                        ...
                        <div className="space-y-3 mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                             {(item.requiredSkills || item.skills || []).slice(0, 3).map((sk, i) => (
                               <span key={i} className="px-2 py-1 bg-[var(--surface-sunken)] rounded text-[11px] font-bold text-[var(--text-secondary)] border border-[var(--border)]">{sk}</span>
                             ))}
                          </div>
                        </div>
